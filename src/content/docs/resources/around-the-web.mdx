...
<CardGrid>
  ...
  />
  <LinkCard
    title="Hyperlight Sandbox + MCP CodeMode: Secure Agent Execution Beyond Containers"
    href="https://dev.to/thangchung/hyperlight-sandbox-mcp-codemode-secure-agent-execution-beyond-containers-3ogc"
    description="A demo of MCP codemode with Hyperlight sandbox."
  />
</CardGrid>
